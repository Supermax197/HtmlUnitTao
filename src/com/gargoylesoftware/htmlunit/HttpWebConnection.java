...
//                       } 
    ...
    private void setProxy(final HttpRequestBase httpRequest, final WebRequest webRequest) {
        ...
        requestBuilder.setLocalAddress(getLocalAddress());
    ...
    private HttpRequestBase makeHttpMethod(final WebRequest webRequest, final HttpClientBuilder httpClientBuilder)
        ...
        //System.out.println(        httpMethod.getConfig());
        return httpMethod;
    }
    ...
    protected InetAddress getLocalAddress() {
        return webClient_.getOptions().getLocalAddress();
    }
    /**
