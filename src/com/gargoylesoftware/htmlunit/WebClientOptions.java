...
public class WebClientOptions implements Serializable {
	...
	private InetAddress LocalAddress_=null;
    ...
    public InetAddress getLocalAddress_() {
		return LocalAddress_;
	}

	public void setLocalAddress_(InetAddress localAddress_) {
		LocalAddress_ = localAddress_;
	}
